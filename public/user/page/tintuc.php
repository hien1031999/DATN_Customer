                                        ...
                                        <form class="input-group search-bar" action="/search" method="get" role="search">
                                            <div class="collection-selector">
                                                ...
                                                <div id="search_info" class="list_search" style="display: none;">
                                                    ...
                                                    <div class="search_item" data-coll-id="1437579">Túi xách Nam</div>
                                                    
                                                    <div class="search_item" data-coll-id="1434181">Túi xách Nữ</div>
                            ...
                            <ul class="ul_menu">
                                ...
                                <li class="nav_item lv1">
                                    ...
                                    <ul class="ul_content_right_1">
                                        ...
                                        <li class="nav_item lv2"><a href="/tui-xach-nam" title="Túi xách nam">Túi xách Nữ</a></li>
                                ...
                                <li class="nav_item lv1">
                                    ...
                                    <ul class="ul_content_right_1">
                                        ...
                                        <li class="nav_item lv2"><a href="/" title="Sản phẩm mới 1">Túi xách mới </a></li>
    
    
    
                                        <li class="nav_item lv2"><a href="/" title="Sản phẩm mới 2">Balo mới</a></li>
    
    
    
                                        <li class="nav_item lv2"><a href="/" title="Sản phẩm mới 3">Vali mới</a></li>
                        ...
                        <div class="menu_hed head_1">
                            <ul class="nav nav_1">
                                ...
                                <li class="menu_hover nav-item nav-items ">
                                    <a href="product.blade.php" class="nav-link ">
                                    ...
                                    <ul class="dropdown-menu border-box">
                                        ...
                                        <li class="dropdown-submenu nav-items nav-item-lv2">
                                            ...
                                            <ul class="dropdown-menu border-box">
                                                ...
                                                <li class="nav-item-lv3">
                                                    <a class="nav-link" href="/tui-xach-nam">Túi xách Nữ</a>
                                                </li>
                                        ...
                                        <li class="dropdown-submenu nav-items nav-item-lv2">
                                            ...
                                            <ul class="dropdown-menu border-box">
                                                ...
                                                <li class="nav-item-lv3">
                                                    <a class="nav-link" href="/">Balo mới</a>
                                                </li>
    
    
                                                <li class="nav-item-lv3">
                                                    <a class="nav-link" href="/">Vali mới</a>
                                                </li>
                                ...
                                <li class=" nav-item nav-items ">
                                    <a href="archive_news.blade.php" class="nav-link">
                                        Tin tức </a>
                                </li>
...
<div class="container">
    <div class="row">
        <div class="col-xs-12 a-left">
            <ul class="breadcrumb">					
                <li class="home">
                    <a itemprop="url" href="index.blade.php" ><span >Trang chủ</span></a>						
...
<div>
    <div class="page_title page__ col-lg-12 col-md-12 col-sm-12 no-padding">
        <div class="dear_title">
            <h2 class="title_head_ border_content2">
                <a href="archive_news.blade.php" title="Tin tức nổi bật">
                    Tin tức nổi bật</a>
            </h2>
        </div>
    </div>
    ...
    <div class="list-blogs">
        <div class="blog_list_item">
            ...
            <span class="view_more_blog"><a href="archive_news.blade.php" title="Xem thêm Tin tức nổi bật">Xem thêm</a></span>
        </div>
    </div>
</div>
</div>
            ...
            <div class="row">
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="item_blog_owl">
                        <article class="blog-item blog-item-grid row">
                            <div class="wrap_blg">
                                <div class="blog-item-thumbnail img1 col-lg-6 col-md-6 col-sm-6 col-xs-12 margin-top-5" onclick="window.location.href='/juno-ra-mat-bo-suu-tap-mua-le-hoi-ket-hop-cung-diem-my-lan-ngoc';">						
                                    <a href="/juno-ra-mat-bo-suu-tap-mua-le-hoi-ket-hop-cung-diem-my-lan-ngoc">
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 content_ar blog_large_item">
                                    <h3 class="blog-item-name"><a class="text2line" href="/juno-ra-mat-bo-suu-tap-mua-le-hoi-ket-hop-cung-diem-my-lan-ngoc" title="Juno ra mắt bộ sưu tập mùa lễ hội, kết hợp cùng Diễm My - Lan Ngọc">Juno ra mắt bộ sưu tập mùa lễ hội, kết hợp cùng Diễm My - Lan Ngọc</a></h3>
                                    <p class="meta">
                                        <span>05 Tháng 01 2018</span> <small>|</small> 
                                        <span></span>
                                    </p>
                                    <div class="summary_ sum text4line">
                                         Juno ra mắt bộ sưu tập mới mang tên “Queens of Fashion” mang tính thời thượng và vô cùng phù hợp cho mùa cuối năm. Bên cạnh đó, hãng còn...
                                    </div>
                                    <a href="/juno-ra-mat-bo-suu-tap-mua-le-hoi-ket-hop-cung-diem-my-lan-ngoc" class="readmore">Đọc tiếp <i class="fa fa-angle-double-right" aria-hidden="true"></i></a>
                                </div>
                            </div>
                        </article>
                    </div>
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="item_blog_owl">
                        <article class="blog-item blog-item-grid row">
                            <div class="wrap_blg">
                                <div class="blog-item-thumbnail img1 col-lg-6 col-md-6 col-sm-6 col-xs-12 margin-top-5" onclick="window.location.href='/dinh-cao-phong-do-anh-trai-mua-tuoi-tu-tuan-showbiz-viet-la-day';">						
                                    <a href="/dinh-cao-phong-do-anh-trai-mua-tuoi-tu-tuan-showbiz-viet-la-day">
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 content_ar blog_large_item">
                                    <h3 class="blog-item-name"><a class="text2line" href="/dinh-cao-phong-do-anh-trai-mua-tuoi-tu-tuan-showbiz-viet-la-day" title="Đỉnh cao phong độ 'anh trai mưa' tuổi tứ tuần showbiz Việt là đây!">Đỉnh cao phong độ 'anh trai mưa' tuổi tứ tuần showbiz Việt là đây!</a></h3>
                                    <p class="meta">
                                        <span>02 Tháng 01 2018</span> <small>|</small> 
                                        <span></span>
                                    </p>
                                    <div class="summary_ sum text4line">
                                         Là một diễn viên đình đám của làng điện ảnh Việt, Hứa Vĩ Văn dù sắp chạm ngưỡng tuổi tứ tuần nhưng về phong độ thì luôn là điều mà khiến...
                                    </div>
                                    <a href="/dinh-cao-phong-do-anh-trai-mua-tuoi-tu-tuan-showbiz-viet-la-day" class="readmore">Đọc tiếp <i class="fa fa-angle-double-right" aria-hidden="true"></i></a>
                                </div>
                            </div>
                        </article>
                    </div>
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="item_blog_owl">
                        <article class="blog-item blog-item-grid row">
                            <div class="wrap_blg">
                                <div class="blog-item-thumbnail img1 col-lg-6 col-md-6 col-sm-6 col-xs-12 margin-top-5" onclick="window.location.href='/nhung-da-nu-khien-phai-may-rau-khong-the-coi-thuong';">						
                                    <a href="/nhung-da-nu-khien-phai-may-rau-khong-the-coi-thuong">
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 content_ar blog_large_item">
                                    ...
                                    <div class="summary_ sum text4line">
                                          Những diễn viên này không chỉ được biết đến là đả nữ trên màn ảnh mà còn là những người đẹp có võ thực sự khiến không ai dám bắt nạt.  
                                    </div>
                                    <a href="/nhung-da-nu-khien-phai-may-rau-khong-the-coi-thuong" class="readmore">Đọc tiếp <i class="fa fa-angle-double-right" aria-hidden="true"></i></a>
                                </div>
                            </div>
                        </article>
                    </div>
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="item_blog_owl">
                        <article class="blog-item blog-item-grid row">
                            <div class="wrap_blg">
                                <div class="blog-item-thumbnail img1 col-lg-6 col-md-6 col-sm-6 col-xs-12 margin-top-5" onclick="window.location.href='/from-now-we-are-certified-web-to-basedu';">						
                                    <a href="/from-now-we-are-certified-web-to-basedu">
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 content_ar blog_large_item">
                                    ...
                                    <a href="/from-now-we-are-certified-web-to-basedu" class="readmore">Đọc tiếp <i class="fa fa-angle-double-right" aria-hidden="true"></i></a>
                                </div>
                            </div>
                        </article>
                    </div>
    ...
    <div class="container">			
        ...
        <div class="footer-bottom clearfix">
            ...
            <ul>
                ...
                <li><a href="archive_product.blade.php">Sản phẩm</a></li>
        ...
        <div class="inner clearfix">
            <div class="row tablet">
                <div  class="col-lg-12 col-md-12 col-sm-12 col-xs-12 fot_copyright a-center">
                    <span class="wsp"><span class="mobile">@2017 Bản quyền thuộc về <b>SMARKET</b></span><span class="hidden-xs"> | </span><span class="mobile">Cung cấp bởi 
